# ANNA Crypto Processing

This document describes the ANNA Service Bureau data processing workflow, which is **Stage 1** of the overall crypto manifest pipeline. The output of this process is used for ISIN-based enrichment of Kaiko data.

**See**: [Crypto Manifest Overview](crypto.md) for the complete hybrid workflow.
